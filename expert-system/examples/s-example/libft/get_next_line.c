...
/*   Updated: 2016/08/18 17:28:07 by sasiedu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static t_gnl	*ft_get_fd_info(int fd, int i)
{
...
int				get_next_line(int fd, char **line)
{
	...
	ret = 1;
	if (fd >= 0 && line != NULL && (temp = ft_get_fd_info(fd, 0)) != NULL)
	{
		*line = NULL;
		while (ret > 0)
		{
