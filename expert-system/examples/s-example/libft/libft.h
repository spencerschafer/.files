...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/07/22 22:15:06 by sasiedu           #+#    #+#             */
/*   Updated: 2016/08/27 10:09:25 by sasiedu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					*ft_memccpy(void *restrict dst, const void *restrict \
		src, int c, size_t n);
...
void					ft_lst_remove_if(t_list **begin_lst, \
		void *data, int (*cmp)());
