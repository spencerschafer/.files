...
#All Spencer's Settings (run these commands in terminal)

#Move launcher button to left
...
#Set correct colours for tmux (this needs to be uncommented)
export TERM=xterm-256color

#Setting alias's
export f="$HOME/.files"
export sf="$HOME/.files/social-tech/front-end"
